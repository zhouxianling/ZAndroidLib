...
public final class LCleanTool {
    ...
    public static boolean cleanInternalCache() {
        return deleteFilesInDir(LTool.getContext().getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return deleteFilesInDir(LTool.getContext().getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return deleteFilesInDir(LTool.getContext().getFilesDir().getParent() + File.separator + "databases");
    }
    ...
    public static boolean cleanInternalDbByName(final String dbName) {
        return LTool.getContext().deleteDatabase(dbName);
    }
    ...
    public static boolean cleanInternalSP() {
        return deleteFilesInDir(LTool.getContext().getFilesDir().getParent() + File.separator + "shared_prefs");
    }
    ...
    public static boolean cleanExternalCache() {
        return Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) && deleteFilesInDir(LTool.getContext().getExternalCacheDir());
    }
