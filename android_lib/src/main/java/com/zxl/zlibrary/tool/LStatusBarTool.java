 ...
 * @since 2017/10/19
 */
public final class LStatusBarTool {
    ...
    public static int getStatusBarHeight() {
        Resources resources = LTool.getContext().getResources();
    ...
    public static void setStatusBarColor(@NonNull final View fakeStatusBar,
        ...
        layoutParams.height = LStatusBarTool.getStatusBarHeight();
    ...
    public static int getNavBarHeight() {
        Resources res = LTool.getContext().getResources();
