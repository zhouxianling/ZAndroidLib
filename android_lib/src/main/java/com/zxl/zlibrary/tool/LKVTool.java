...
public class LKVTool {
     ...
     */
    public LKVTool(Context context, String kvName, int mode) {
     ...
     * @return 引用的KV对象。
     */
    public LKVTool put(String key, Object value) {
        if (value == null) {
     ...
     * @return 引用的KV对象。
     */
    public LKVTool remove(String key) {
        mEditor.remove(key);
        return this;
    }
