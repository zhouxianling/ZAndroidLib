...
public final class LActivityTool {
    ...
    public static boolean isActivityExists(@NonNull final String packageName,
        ...
        return !(LTool.getContext().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(LTool.getContext().getPackageManager()) == null ||
                LTool.getContext().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(LTool.getContext().getPackageName());
    }
    ...
    public static String getLauncherActivity(@NonNull final String packageName) {
        ...
        PackageManager pm = LTool.getContext().getPackageManager();
    ...
    public static Activity getTopActivity() {
        if (LTool.sTopActivityWeakRef != null) {
            Activity activity = LTool.sTopActivityWeakRef.get();
            if (activity != null) {
                return activity;
            }
        }
        List<Activity> activities = LTool.sActivityList;
    ...
    public static void finishAllActivities(final boolean isLoadAnim) {
        List<Activity> activityList = LTool.sActivityList;
    ...
    private static Context getActivityOrApp() {
        ...
        return topActivity == null ? LTool.getContext() : topActivity;
    }
